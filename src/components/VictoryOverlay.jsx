  ...
  return (
    <div className="victory-overlay fixed top-0 left-0 w-screen h-screen flex items-center justify-center z-50">
      ...
      <div className="victory-content relative bg-gradient-to-br from-emerald-400 via-emerald-500 to-emerald-600 text-white rounded-2xl shadow-2xl p-8 md:p-12 text-center max-w-md mx-4">
        ...
        {/* Victory Message */}
        <h2 className="text-2xl md:text-3xl font-bold mb-2">Level Complete!</h2>
        ...
        <div className="space-y-3">
          <div className="text-emerald-50 text-base">Next level in...</div>
          ...
          <div className="timer-circle relative inline-flex items-center justify-center w-16 h-16 bg-white/20 rounded-full">
            ...
            <svg
              className="timer-ring absolute inset-0 w-full h-full -rotate-90"
              viewBox="0 0 64 64"
            >
              <circle
                cx="32"
              ...
              <circle
                ...
                style={{
                  ...
                  strokeDashoffset: `${
                    176 *
                    (1 - (totalDuration - autoProgressTimer) / totalDuration)
                  }`,
        ...
        {onClose && (
          <button
            onClick={onClose}
            className="mt-4 px-4 py-2 bg-white hover:bg-gray-50 text-emerald-600 hover:text-emerald-700 font-semibold text-sm rounded-lg border border-emerald-200 hover:border-emerald-300 transition-all duration-200 shadow-lg hover:shadow-xl"
          >
            Skip to next level
          </button>
        )}
